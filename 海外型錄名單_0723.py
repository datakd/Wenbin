...
silent_df = pd.read_excel('C:/Users/11020856/Desktop/jupyter/0821經營開發客戶標籤.xlsx')
...
while True:
    ...
    if not crm['queryLocator']:
        break
    queryLocator = crm['queryLocator']
first_df = pd.merge(use_account, info_df, on = '公司代號', how = 'left')
...
contact_final.to_excel("C:/Users/11020856/Desktop/jupyter/海外有效型錄0729.xlsx",index = False) 
